...
public class ArrayStack<T extends Number> implements CustomStack<T> {
    ...
    /**
     * Removes & returns top elem from stack
    ...
    /**
     * Returns number of elem in stack
    ...
    /**
     * Resizes array when it becomes full
     */
    private void resize() {
    ...
    /**
     * Adds top two elem and pushes result back onto the stack
    ...
    public void addTopTwo() {
        ...
        if (first instanceof Integer && second instanceof Integer) {
            Integer sum = first.intValue() + second.intValue();
            push((T) sum);
        } else {
    ...
    /**
     * Gets statistics for stack instance
     */
